        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 text-lg">Manage your vehicles and track their information</p>
            </div>
        ...
        {vehicles.length === 0 ? (
          <Card className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
            <CardContent className="text-center py-16">
              ...
              <p className="text-muted-foreground mb-6">Add your first vehicle to get started with fuel tracking</p>
              <Button asChild>
                <Link href="/fuel-log/vehicles/new">
                  <Plus className="mr-2 h-4 w-4" />
                  Add Vehicle
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium capitalize">{vehicle.fuel_type.replace("_", " ")}</span>
                    </div>
                  </div>

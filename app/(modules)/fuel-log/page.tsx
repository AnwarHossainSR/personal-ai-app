...
import { Car, DollarSign, Fuel, Plus, TrendingUp, Wrench } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-teal-100 text-lg">
              Track your vehicle fuel consumption and maintenance costs
            </p>
          </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Fuel expenses over the last 6 months
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Fuel consumption over the last 6 months
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
            ...
            {stats.recentEntries.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  No entries yet. Add your first vehicle to get started!
                </p>

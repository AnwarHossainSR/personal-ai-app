...
import { Activity, Users, Zap, TrendingUp, Car } from "lucide-react"
    ...
    <AppLayout>
      <div className="space-y-8 p-6">
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-teal-100 text-lg">Welcome back! Here's an overview of your modules and recent activity.</p>
        </div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                ...
                <div>
                  <p className="font-medium text-blue-800 dark:text-blue-200">Welcome to the Modular App</p>
                  <p className="text-sm text-blue-600 dark:text-blue-400">Explore the available modules</p>
                </div>
              </div>
            </div>
          </div>
